                             ...
                             const std_msgs::Header &header)
{
    ...
    // 3.Calibrate rotational extrinsics
...
void Estimator::optimization()
{
    ...
    if (ESTIMATE_TD)
    {
        problem.AddParameterBlock(para_Td[0], 1); // 滑窗内第一个时刻相机到IMU时钟差 
